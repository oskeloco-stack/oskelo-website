...
// the `site_content` table whose `value` (jsonb) replaces the hardcoded default
// exported from lib/work.js, lib/services.js, lib/offers.js.
export const CONTENT_KEYS = ['work', 'services', 'offers'];
